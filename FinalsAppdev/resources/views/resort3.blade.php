...
<head>
    ...
    <style>
        .hero {
            background-image: url('{{ asset('images/padre burgos castle resort.jpg') }}');
...
<body>
    ...
    <section class="hero">
        ...
        <div class="container h-100 d-flex justify-content-center align-items-center hero-content text-center">
            <div>
                <h1 class="display-3 fw-bold">PADRE BURGOS CASTLE RESORT</h1>
        ...
        <div class="container">
            ...
            @php
                $accommodations = [
                    ...
                    [
                        'title' => 'Superior Room',
                        'image' => 'images/r3 bedroom.jpg',
                        'desc' => 'Comfortable and spacious air-conditioned room with garden or sea views, perfect for relaxation.',
                        'price' => '₱2,000 – ₱3,000 per night',
                        'rating' => 4,
                        'checkin' => '2:00 PM',
                        'checkout' => '11:00 AM',
                        'amenities' => ['Air Conditioning', 'Double Bed', 'Private Bathroom', 'Free Wi-Fi'],
                        'more' => 'Includes complimentary bottled water and toiletries. Ideal for couples or solo travelers.',
                    ],
                    [
                        'title' => 'Island Hopping',
                        'image' => 'images/r3 island hopping.jpg',
                        'desc' => 'Explore nearby islands, secluded beaches, and hidden coves with our guided island hopping tours.',
                        'price' => '₱1,200 – ₱1,800 per tour',
                        'rating' => 5,
                        'checkin' => 'Session starts: 8:00 AM',
                        'checkout' => 'Session ends: 5:00 PM',
                        'amenities' => ['Boat Ride', 'Snorkel Gear', 'Guide Service'],
                        'more' => 'Tour includes lunch and snacks on the beach. Ideal for sightseeing, snorkeling, and adventure.',
                    ],
                ];
            @endphp
